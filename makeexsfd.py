...
diacriticdata: list[tuple[str, Optional[str], int, str, int, int]] = [
    ...
    ('doublebrevebelow', None, 0x35c, 'uni035C', 0, 0),
...
def precomposedForms(font: fontforge.font):
    ...
    proscribedDecomp = {
        ...
        # Iota adscript (prosgegrammeni)
        'Alphaiotasublenis': [('Alphalenis', 'ypogegrammenigreekcmb')],
        'Alphaiotasubasper': [('Alphaasper', 'ypogegrammenigreekcmb')],
        'Alphaiotasublenisgrave': [('Alphalenisgrave', 'ypogegrammenigreekcmb')],
        'Alphaiotasubaspergrave': [('Alphaaspergrave', 'ypogegrammenigreekcmb')],
        'Alphaiotasublenisacute': [('Alphalenisacute', 'ypogegrammenigreekcmb')],
        'Alphaiotasubasperacute': [('Alphaasperacute', 'ypogegrammenigreekcmb')],
        'Alphaiotasublenistilde': [('Alphalenistilde', 'ypogegrammenigreekcmb')],
        'Alphaiotasubaspertilde': [('Alphaaspertilde', 'ypogegrammenigreekcmb')],
        'Etaiotasublenis': [('Etalenis', 'ypogegrammenigreekcmb')],
        'Etaiotasubasper': [('Etaasper', 'ypogegrammenigreekcmb')],
        'Etaiotasublenisgrave': [('Etalenisgrave', 'ypogegrammenigreekcmb')],
        'Etaiotasubaspergrave': [('Etaaspergrave', 'ypogegrammenigreekcmb')],
        'Etaiotasublenisacute': [('Etalenisacute', 'ypogegrammenigreekcmb')],
        'Etaiotasubasperacute': [('Etaasperacute', 'ypogegrammenigreekcmb')],
        'Etaiotasublenistilde': [('Etalenistilde', 'ypogegrammenigreekcmb')],
        'Etaiotasubaspertilde': [('Etaaspertilde', 'ypogegrammenigreekcmb')],
        'Omegaiotasublenis': [('Omegalenis', 'ypogegrammenigreekcmb')],
        'Omegaiotasubasper': [('Omegaasper', 'ypogegrammenigreekcmb')],
        'Omegaiotasublenisgrave': [('Omegalenisgrave', 'ypogegrammenigreekcmb')],
        'Omegaiotasubaspergrave': [('Omegaaspergrave', 'ypogegrammenigreekcmb')],
        'Omegaiotasublenisacute': [('Omegalenisacute', 'ypogegrammenigreekcmb')],
        'Omegaiotasubasperacute': [('Omegaasperacute', 'ypogegrammenigreekcmb')],
        'Omegaiotasublenistilde': [('Omegalenistilde', 'ypogegrammenigreekcmb')],
        'Omegaiotasubaspertilde': [('Omegaaspertilde', 'ypogegrammenigreekcmb')],
        'Alphaiotasub': [('Alpha', 'ypogegrammenigreekcmb')],
        'Etaiotasub': [('Eta', 'ypogegrammenigreekcmb')],
        'Omegaiotasub': [('Omega', 'ypogegrammenigreekcmb')],
    }
