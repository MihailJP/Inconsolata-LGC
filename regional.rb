...
t = {
	...
	"pedantic" => {namesuffix: "Pedantica",  swap: {
		...
		"lcaron" => "lcaron.alt",
		"tcaron" => "tcaron.alt",
		"Acircumflexacute" => "Acircumflexacute.alt",
		"acircumflexacute" => "acircumflexacute.alt",
		"Ecircumflexacute" => "Ecircumflexacute.alt",
		"ecircumflexacute" => "ecircumflexacute.alt",
		"Ocircumflexacute" => "Ocircumflexacute.alt",
		"ocircumflexacute" => "ocircumflexacute.alt",
		"Acircumflexgrave" => "Acircumflexgrave.alt",
		"acircumflexgrave" => "acircumflexgrave.alt",
		"Ecircumflexgrave" => "Ecircumflexgrave.pinyin",
		"ecircumflexgrave" => "ecircumflexgrave.pinyin",
		"Ocircumflexgrave" => "Ocircumflexgrave.alt",
		"ocircumflexgrave" => "ocircumflexgrave.alt",
		"Acircumflexhookabove" => "Acircumflexhookabove.alt",
		"acircumflexhookabove" => "acircumflexhookabove.alt",
		"Ecircumflexhookabove" => "Ecircumflexhookabove.alt",
		"ecircumflexhookabove" => "ecircumflexhookabove.alt",
		"Ocircumflexhookabove" => "Ocircumflexhookabove.alt",
		"ocircumflexhookabove" => "ocircumflexhookabove.alt",
		"ydotbelow" => "ydotbelow.alt",
	}},
}
